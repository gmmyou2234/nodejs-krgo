...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'krgo.moese.eu.cc';          //【2】固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmY3ZGJmYmU5MjVkN2UyMmI5NWY4N2NhYmRiOWUxMGEiLCJ0IjoiMWQ5MmE3YTEtODUwOS00MTdjLTkxYjgtNjMzNThkZWQ0NDAwIiwicyI6Ik9UUXhaR0l3WWpVdE5EVTJOQzAwTVdKakxUZzFNRFl0WkdRd1pEaGlORFl5TURSaCJ9';              // 【3】固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            //【1】 固定隧道端口,使用token需在cloudflare后台设置和这里一致
...
const NAME = process.env.NAME || 'krgo';                        //【4】 节点名称
